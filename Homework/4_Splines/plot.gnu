...
set xlabel "x"
set ylabel "y"
plot 'quad.txt' using 1:2 with lines title 'Linear Spline', \
     '' using 1:3 with lines title 'Integral', \
...
set xlabel "x"
set ylabel "y"
plot 'log.txt' using 1:2 with lines title 'Quadratic Spline', \
     '' using 1:3 with lines title 'Integral', \
     '' using 1:4 with lines title 'Derivative', \
...
plot 'sqrt.txt' using 1:2 with lines title 'My Cubic Spline', \
     'In_Task_C/sqrt_data_points_to_Gnuplot.txt' using 1:2 with linespoints smooth csplines title 'Gnuplot Cubic Spline'
...
set xlabel "i"
set ylabel "b_i"
plot 'In_Task_B/Manually_calculate_bi_and_ci_sin.txt' using 1:2 with linespoints title 'Manual b_i', \
...
set xlabel "i"
set ylabel "c_i"
plot 'In_Task_B/Manually_calculate_bi_and_ci_sin.txt' using 1:3 with linespoints title 'Manual c_i', \
...
set xlabel "i"
set ylabel "b_i"
plot 'In_Task_B/Manually_calculate_bi_and_ci_log.txt' using 1:2 with linespoints title 'Manual b_i', \
...
set xlabel "i"
set ylabel "c_i"
plot 'In_Task_B/Manually_calculate_bi_and_ci_log.txt' using 1:3 with linespoints title 'Manual c_i', \
